...
class VNPay
{
     ...
     *
     */
    static $vnp_TmnCode = "KDQEZOMC"; //Mã website tại VNPAY
    static $vnp_HashSecret = "VTEYSMMFHJUXVHTIRQAMPWVOJUDLTDAW"; //Chuỗi bí mật
...
//        $vnp_BankCode = 'NCB';
        ...
        $vnp_expire= date('YmdHis',strtotime('+8 hours', strtotime($startTime)));

                            ...
                            <div class="product-details">
                                ...
                                <div class="pd-size-choose">
                                    @if($product->tag === 'Clothing')
                                        ...
                                        @endfor
                                            ...
                                            <div class="sc-item">
                                                <a href="./shop/product/{{ $product->id }}/3">
                                                    <input id="sm-L">
                                                    <label for="sm-L" id="sm-L" class="active">L</label>
                                                </a>
                                            </div>
                                        ...
                                        @for($i = 0; $i < count($product->productDetails); $i++)
                                            @if($product->productDetails[$i]->size == 'L' )
                                                <ul class="pd-tags">
                                ...
                                <div class="quantity">
                                    <div class="quantity">
                                        <div class="pro-qty">
                                            <input type="text" value="1" id="qty-addtocart-L-{{ $product->id }}" name="qty">
                                        </div>
                                        <a href="javascript:addToCartL({{ $product->id }})" class="primary-btn pd-cart">Add To Cart</a>
                                    </div>
                                </div>
                                <ul class="pd-tags">

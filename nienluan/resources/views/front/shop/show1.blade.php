...
{{--                                </div>--}}
                                <div class="pd-size-choose">
                                        ...
                                        <div class="sc-item">
                                            <a href="./shop/product/{{ $product->id }}/1">
                                                <input id="sm-S">
                                                <label for="sm-S" id="sm-S" class="active">S</label>
                                            </a>
                                        </div>
                                        ...
                                        @for($i = 0; $i < count($product->productDetails); $i++)
                                            @if($product->productDetails[$i]->size == 'S' )
                                ...
                                <div class="quantity">
                                    <div class="quantity">
                                        <div class="pro-qty">
                                            <input type="text" value="1" id="qty-addtocart-S-{{ $product->id }}" name="qty">
                                        </div>
                                        <a href="javascript:addToCartS({{ $product->id }})" class="primary-btn pd-cart">Add To Cart</a>
                                    </div>
                                </div>
                                <ul class="pd-tags">

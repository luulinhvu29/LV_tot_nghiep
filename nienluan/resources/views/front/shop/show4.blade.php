                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="product-pic-zoom">
                                <img class="product-big-img" src="front/img/products/{{ $product->productImages[0]->path }}" alt="" height="459px">
                                <div class="zoom-icon">
                            ...
                            <div class="product-details">
                                ...
                                <div class="pd-size-choose">
                                    @if($product->tag === 'Clothing')
                                        ...
                                        @for($i = 0; $i < count($product->productDetails); $i++)
                                            @if($product->productDetails[$i]->size == 'M' and $product->productDetails[$i]->qty > 0)
                                                <div class="sc-item">
                                                    <a href="./shop/product/{{ $product->id }}/2">
                                                        <input id="sm-M">
                                                        <label for="sm-M" id="sm-M">M</label>
                                                    </a>
                                                </div>
                                        ...
                                        <div class="sc-item">
                                            <a href="./shop/product/{{ $product->id }}/4">
                                                <input   id="sm-XS">
                                                <label for="sm-XS" id="sm-XS" class="active">XS</label>
                                            </a>
                                        </div>
                                ...
                                <div class="quantity">
                                    <div class="quantity">
                                        <div class="pro-qty">
                                            <input type="text" value="1" id="qty-addtocart-XS-{{ $product->id }}" name="qty" >
                                        </div>
                                        <a href="javascript:addToCartXS({{ $product->id }})" class="primary-btn pd-cart">Add To Cart</a>
                                    </div>
                                </div>
                                <ul class="pd-tags">

                ...
                <div class="main-card mb-3 card">
                    ...
                    <div class="card-header">
                        ...
                        <div class="btn-actions-pane-right">
                            <div class="text-center">Số lượng còn lại: {{ $nk - $product->qty - $db}}</div>
                        </div>

                        <div class="btn-actions-pane-right">
                            <div class="text-center">Số lượng nhập kho: {{ $nk}}</div>
                        </div>

                        <div class="btn-actions-pane-right">
                            <div class="text-center">Số lượng đã bán: {{ $db}}</div>
                        </div>

...
<head>
    ...
    <title>@yield('title') | Linh Vu Shop</title>
    <meta name="viewport"
                    ...
                    <ul class="vertical-nav-menu">
                        ...
                        <li class="mm-active">
                            ...
                            <ul>
                                ...
                                @if(Auth::user()->authority[0]->order == true)
                                    <li>
                                ...
                                @if(Auth::user()->authority[0]->pro == true)
                                    <li>
                                ...
                                @if(Auth::user()->authority[0]->cate == true)
                                    <li>
                                        <a href="./admin/category" class="{{ (request()->segment(2) == 'category') ? 'mm-active' : '' }}">
                                            <i class="metismenu-icon"></i>Danh mục / Loại
                                        </a>
                                    </li>
                                @endif

                                @if(Auth::user()->authority[0]->brand == true)
                                    <li>
                                ...
                                @if(Auth::user()->authority[0]->enter == true)
                                    <li>
                                        <a href="./admin/enter_coupon" class="{{ (request()->segment(2) == 'enter_coupon') ? 'mm-active' : '' }}">
                                            <i class="metismenu-icon"></i>Phiếu nhập
                                        </a>
                                    </li>
                                @endif

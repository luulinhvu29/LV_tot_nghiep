                ...
                <div class="app-sidebar__inner">
                    <ul class="vertical-nav-menu">
                        ...
                        <li class="mm-active">
                            ...
                            <ul>
                                <li>
                                    <a href="./partner/index" class="{{ (request()->segment(2) == 'index') ? 'mm-active' : '' }}">
                                        <i class="metismenu-icon"></i>Tất cả
                                    </a>
                                </li>


                                <li>
                                    <a href="./partner/shipping" class="{{ (request()->segment(2) == 'shipping') ? 'mm-active' : '' }}">
                                        <i class="metismenu-icon"></i>Đang vận chuyển
                                    </a>
                                </li>

                                <li>
                                    <a href="./partner/finish" class="{{ (request()->segment(2) == 'finish') ? 'mm-active' : '' }}">
                                        <i class="metismenu-icon"></i>Đã hoàn thành
                                    </a>
                                </li>
